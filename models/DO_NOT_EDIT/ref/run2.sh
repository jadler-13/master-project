...
phenix.fmodel ../replace_this.pdb high_resolution=1.79 k_sol=0.362 b_sol=72.5 > fmodellog

#expand reflections to spacegroup P1;
phenix.reflection_file_converter --expand_to_p1 replace_this.pdb.mtz --mtz=temp-p1.pdb.mtz > rfclog
...
#create and refine a new model and electron density, calculate R-factors and mean protein B-factor;
cd refine || exit
